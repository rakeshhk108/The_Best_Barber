...
class AdminServiceTest {
    ...
    void testUpdateService() {
        ...
        barberServiceList.setServiceName("Service Name");
        barberServiceList.setServicePrice(1);
        Optional<BarberServiceList> ofResult = Optional.of(barberServiceList);

        BarberServiceList barberServiceList1 = new BarberServiceList();
        barberServiceList1.setServiceId(123);
        barberServiceList1.setServiceName("Service Name");
        barberServiceList1.setServicePrice(1);
        when(barberServicesRepo.saveAndFlush((BarberServiceList) any())).thenReturn(barberServiceList1);
        when(barberServicesRepo.findById((Integer) any())).thenReturn(ofResult);

        BarberServiceList barberServiceList2 = new BarberServiceList();
        barberServiceList2.setServiceId(123);
        barberServiceList2.setServiceName("Service Name");
        barberServiceList2.setServicePrice(1);
        assertSame(barberServiceList1, adminService.updateService(123, barberServiceList2));
        verify(barberServicesRepo).saveAndFlush((BarberServiceList) any());
        verify(barberServicesRepo).findById((Integer) any());
    }

    /**
     * Method under test: {@link AdminService#updateService(Integer, BarberServiceList)}
     */
    @Test
    void testUpdateService2() {
        ...
        barberServiceList1.setServiceName("Service Name");
        barberServiceList1.setServicePrice(1);
        assertThrows(ResourceNotFoundException.class, () -> adminService.updateService(123, barberServiceList1));
        verify(barberServicesRepo).saveAndFlush((BarberServiceList) any());
        verify(barberServicesRepo).findById((Integer) any());
    }
    ...
    /**
     * Method under test: {@link AdminService#fetchUserByemailIdAndPassword(Admin)}
     */
    @Test
